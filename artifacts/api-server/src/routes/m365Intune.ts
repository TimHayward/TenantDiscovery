...
import {
  ...
  getPermissionMetadataForFeatures,
  ...
  try {
    ...
    const fieldMetadata = {
      totalDevices: {
        ...
        notes: ["Falls back to compliance summary when managedDevices list is unavailable"],
      },
      overallCompliancePercent: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
        sourceLabel: "DeviceManagementManagedDevices.Read.All",
        notes: ["Computed from available device or summary counts"],
      },
      compliantDevices: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
        sourceLabel: "DeviceManagementManagedDevices.Read.All",
        notes: ["May be sourced from summary endpoint when device list is denied"],
      },
      nonCompliantDevices: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
      ...
      totalCompliancePolicies: {
        ...
        sourceLabel: "DeviceManagementConfiguration.Read.All",
        notes: ["Count of compliance policies from Graph deviceManagement endpoint"],
      },
      totalConfigProfiles: {
        evidenceStatus: "apiBacked" as const,
        confidenceLabel: "high" as const,
        sourceLabel: "DeviceManagementConfiguration.Read.All",
        notes: ["Count of device configuration profiles from Graph"],
      },
      totalAppProtectionPolicies: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
      ...
      enrolledByOS: {
        ...
        confidenceLabel: "medium" as const,
        sourceLabel: "DeviceManagementManagedDevices.Read.All",
        notes: ["Available only when managed device list is accessible"],
      },
      complianceByState: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
        sourceLabel: "DeviceManagementManagedDevices.Read.All",
        notes: ["Combines direct device states with summary fallback"],
      },
      deviceList: {
        evidenceStatus: "partial" as const,
        confidenceLabel: "medium" as const,
        sourceLabel: "DeviceManagementManagedDevices.Read.All",
        notes: ["Empty when permission denied or endpoint unavailable"],
      },
      permissionRequired: {
        evidenceStatus: "apiBacked" as const,
        confidenceLabel: "high" as const,
        sourceLabel: "HTTP status inspection",
        notes: ["True when managedDevices endpoint returns 401/403"],
      },
      deviceListAvailable: {
        evidenceStatus: "apiBacked" as const,
        confidenceLabel: "high" as const,
        sourceLabel: "Route execution state",
        notes: ["Indicates whether detailed device list is present"],
      },
    };
  ...
  try {
    ...
    if (policyStatesResult.permissionDenied) {
      return res.status(403).json({
        ...
        permissionMetadata: getPermissionMetadataForFeature("intune-devices"),
      });
    }
...
router.get("/m365/intune/apps", async (req, res) => {
  try {
    const intuneAppsPermissionMetadata = getPermissionMetadataForFeatures([
      "intune-app-installations",
    ...
    const data = await getCached("m365-intune-apps", async () => {
      ...
      return {
        ...
        permissionMetadata: intuneAppsPermissionMetadata,
